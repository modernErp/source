...
/**
 * @Class Name : Et9980Controller.java
...
@Controller
public class Et9980Controller {

    @Resource(name = "Et9980Service")
    private Et9980Service Et9980service;

    @Resource(name = "myBuilderData")
    private MyBuilderData myBuilderData;
    
    @RequestMapping(value = "/Et9980Controller.do")
    public String Et9980Controller(HttpServletRequest StrData, ModelMap model) throws Exception {
        ...
        switch(strSVCID){
            case "SEARCH01" : //전표별매입기본내역
                List<?> resultList01 = Et9980service.selectEt9980_01(paramMap); 
                model.addAttribute("resultList", resultList01);
                break;
                
            case "SEARCH02" : //전표별매입상세내역
                List<?> resultList02 = Et9980service.selectEt9980_02(paramMap);
                model.addAttribute("resultList", resultList02);
                break;
                
            case "SEARCH03" : //전표-물품별매입내역
                List<?> resultList03 = Et9980service.selectEt9980_03(paramMap);
