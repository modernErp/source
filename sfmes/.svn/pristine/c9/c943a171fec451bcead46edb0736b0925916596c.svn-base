...
@Controller
public class PDACo1035Controller {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/PDAco1035Controller.do")
	public String PDAco1035Controller(HttpServletRequest strData, ModelMap model) throws Exception 
	{
