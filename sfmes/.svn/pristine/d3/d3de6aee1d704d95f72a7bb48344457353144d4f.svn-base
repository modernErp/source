...
/**
 * @Class Name : PDALoginController.java
...
public class PDALoginController {
     ...
     * @exception Exception
     */
    @RequestMapping(value = "/PDAlogin.do")
    public String PDAloginController(HttpServletRequest strData, HttpServletRequest request, ModelMap model) throws Exception {
        ...
        System.out.println("myBuilderData_PDA :: " + myBuilderData_PDA);
        
        // 전송된 파라미터를 추출한다.
        strSVCID = myBuilderData_PDA.getParam("SVCID");  // 분기용 ID 
        //INMSV01 = myBuilderData_PDA.getParam("INMSV01"); 
        
        // 입력된 MSV타입 파라미터를 MAP형태로 변환한다.
        LinkedHashMap paramMap = myBuilderData_PDA.getParamFromMSVHashMap(myBuilderData_PDA.getParam("INMSV01"));
        //세션초기화
        request.getSession().removeAttribute("LOGIN_INFO");
        request.getSession().invalidate();
        
        System.out.println(paramMap + " ::::::::: [PDALoginController] paramMap ");
