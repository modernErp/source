...
public class Sm1010Controller {
     ...
     * @exception Exception
     */
    @RequestMapping(value = "/sm1010Controller.do")
    public String sm1010Controller(HttpServletRequest strData, ModelMap model) throws Exception 
    {
        ...
        List<Map<String, Object>> paramList = myBuilderData.getParamFromMSVList(inMSV02);       // 수정된 데이터
        List<Map<String, Object>> paramList3 = myBuilderData.getParamFromMSVList(inMSV03);       // 수정된 데이터
 
        List<?> resultList = null;
        
        switch(strSVCID) {
        case "SAVE01" :     //입고내역저장
            result = callService.saveSm1010_2(paramMap, paramList);
