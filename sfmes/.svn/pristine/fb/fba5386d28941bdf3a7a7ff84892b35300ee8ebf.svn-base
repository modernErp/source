...
@Controller
public class Et9970Controller {

    @Resource(name = "Et9970Service")
    private Et9970Service Et9970service;

    @Resource(name = "myBuilderData")
    private MyBuilderData myBuilderData;
    
    @RequestMapping(value = "/Et9970Controller.do")
    public String Et9970Controller(HttpServletRequest StrData, ModelMap model) throws Exception {
        ...
        switch(strSVCID){
            case "SEARCH01" : //전표별매입기본내역
                List<?> resultList01 = Et9970service.selectEt9970_01(paramMap); 
