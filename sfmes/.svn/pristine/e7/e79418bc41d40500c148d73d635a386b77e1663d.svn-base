...
<%@page import="com.sfmes.cm.web.MyBuilderData"%>
...
//    String testValue = (String)request.getAttribute("returnValue01");
    String uploadKey = null;
    
    if( request.getAttribute("result") != null ){
        uploadKey = (String)request.getAttribute("uploadKey");
    }
    /*
    ...
    */
    System.out.print("upload.jsp ====> upload Key ::" + uploadKey);
    
    out.print("Upload: OK " + uploadKey);
    out.flush();
%>