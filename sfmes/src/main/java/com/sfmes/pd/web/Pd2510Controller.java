...
/**
* @Class Name : Pd2510Controller.java
...
@Controller
public class Pd2510Controller {
    
    @Resource(name = "myBuilderData")
    protected MyBuilderData myBuilderData;
    
    @Resource(name = "Pd2510Service")
    private Pd2510Service callService;
     ...
     * @exception Exception
     */
    @RequestMapping(value = "/pd2510Controller.do")
    public String pd2510Controller(HttpServletRequest strData, ModelMap model) throws Exception 
    {
        ...
        case "INSERT" :
            //공정기록서 기반 작업지시등록
            callService.insertPd2510(paramMap, paramList01, paramList02);
        ...
        case "UPDATE" :
            //공정기록서 기반 작업지시변경
            callService.updatePd2510(paramMap, paramList01, paramList02);
            model.addAttribute("result", "OK");
            break;
            
        case "SEARCH01" :
            //공정기록서 기반 작업지시 기본정보조회
            resultList = callService.selectPd2510List_01(paramMap);
        ...
        case "SEARCH03" :
            ...
            resultList = callService.selectPd2510List_03(paramMap);
            model.addAttribute("resultList", resultList);
            break;
            
        case "SEARCH04" :
            //공정기록서 제품상세(저장전)
            resultList = callService.selectPd2510List_04(paramMap);
            model.addAttribute("resultList", resultList);
            break;
            
        case "SEARCH05" :
            //공정기록서 투입상세(저장전)
            resultList = callService.selectPd2510List_05(paramMap);
            model.addAttribute("resultList", resultList);
            break;
