<%@page contentType="text/html; charset=utf-8" pageEncoding="utf-8"%><%@page import="org.apache.taglibs.standard.lang.jstl.EnumeratedMap"%><%@page import="com.sfmes.cm.web.MyBuilderData_PDA"%><%@page import="java.util.*"%><%

    String _DELIM_COL  = "\010";
    String _DELIM_ROW  = "\014";
    MyBuilderData_PDA myBld = new MyBuilderData_PDA();
    ...
    if ( request.getAttribute("result") != null )
    {
        ...
        sbMSV.append(myBld.Encode("msgCode" + _DELIM_COL + "msgName" + _DELIM_COL + "returnValue01" + _DELIM_COL + "returnValue02"));
        sbMSV.append(_DELIM_ROW);
        ...
        System.out.print(sbMSV.toString());
        ...
        if(resultList.isEmpty() == true) {
            ...
            sbMSV.append(myBld.Encode("msgCode" + _DELIM_COL + "msgName" + _DELIM_COL + "returnValue01" + _DELIM_COL + "returnValue02"));
            sbMSV.append(_DELIM_ROW);
            sbMSV.append(myBld.Encode("NOT_FOUND" + _DELIM_COL + "조회 된 결과가 없습니다."));
        } else {
            ...
            sbMSV.append(myBld.Encode("msgCode" + _DELIM_COL + "msgName" + _DELIM_COL + "returnValue01" + _DELIM_COL + "returnValue02"));
            sbMSV.append(_DELIM_ROW);
            sbMSV.append(myBld.Encode("LIST_OK" + _DELIM_COL + "정상적으로 조회되었습니다."));
        }
    }
